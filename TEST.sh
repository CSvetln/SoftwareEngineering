...
libs="lib/kotlinx-cli-jvm-0.2.0-SNAPSHOT.jar${platform}lib/log4j-api-2.12.1.jar${platform}lib/log4j-core-2.12.1.jar${platform}lib/h2-1.4.200.jar${platform}lib/flyway-core-6.1.1.jar"
...
fh 0 "-login admin -pass admin -role READ -res AB.C.D"
fh 0 "-login admin -pass admin -role READ -res A.C.D"
